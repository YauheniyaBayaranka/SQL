...
/*10. Вывести пользователей где в имени есть слово Анна*/
 select name from students
 where name like '%Anna%' or name like 'Anna%' or name like 'Anna';
...
select name from students 
 where created_on ='2021-07-12 00:00:00' and name like '%Andrey%' or name like 'Andrey%' or name like '%Andrey';

/*16. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть цифра 8*/
select name from students 
where created_on ='2021-07-12 00:00:00' and name like '%8%' or name like '8%' or name like '%8'; 
